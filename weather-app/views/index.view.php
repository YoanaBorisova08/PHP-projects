...
<html lang="en">
  ...
  <body>
    <?php 
    $backgrounds = [
        'stormy' => 'imgs/stormy/bg.svg',
        'cloudy' => 'imgs/cloudy/bg.svg',
        'snowy' => 'imgs/snowy/bg.svg',
        'sunny' => 'imgs/sunny/bg.svg'
    ]; 
    $bgImage = null;
    ...
    >
      <div class="top-bar">
        ...
        <div class="top-bar__date"><?php echo e(date('l')); ?>, <?php echo e(date('d')); ?><sup>th</sup></div>
      </div>
      <div class="weather-info">
        <?php 
        $images = [
            'stormy' => 'imgs/stormy/large.svg',
            'cloudy' => 'imgs/cloudy/large.svg',
            'snowy' => 'imgs/snowy/large.svg',
            'sunny' => 'imgs/sunny/large.svg'
        ]; 
        $largeImage = null;
        if (isset($backgrounds[$info->weatherType])){
        ...
        <img
          ...
          src="<?php echo e($largeImage); ?>"
          alt="<?php echo e($info->weatherType); ?>"
        />
        <?php endif; ?>
        <h1 class="weather-info__temp"><?php echo e($info->getCelsius()); ?>C</h1>
